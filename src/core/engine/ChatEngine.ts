...
import { SearchResultsPayload, type RequestPayload } from "../messaging/WhatsAppTypes";
...
export class ChatEngine {
  ...
  async processMessage(userId: string, messagePayload: RequestPayload | SearchResultsPayload): Promise<string> {
